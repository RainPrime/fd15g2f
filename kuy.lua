if game.PlaceId == 2753915549 then
 ...
 ImageButton.Image = "rbxassetid://117690494697166"
 
 UICorner.Parent = ImageButton	
 
 ClickSound.Parent = ImageButton
 ClickSound.SoundId = "rbxassetid://117690494697166"
 ClickSound.Volume = 1
 ...
 local Tabs = {
     Main = Window:AddTab({ Title = "General", Icon = "rbxassetid://117690494697166" }),
     ...
     TP = Window:AddTab({ Title = "Island", Icon = "rbxassetid://117690494697166" }),
     ESP = Window:AddTab({ Title = "ESP", Icon = "eye" }),   
     Shop = Window:AddTab({ Title = "Shop", Icon = "rbxassetid://117690494697166" }), 
     Misc = Window:AddTab({ Title = "Misc", Icon = "rbxassetid://117690494697166" }),
 }
 ...
 local Main = Tabs.Main:AddSection("เครดิต Rain")
 Tabs.Main:AddParagraph({
         Title = "NEXUS HUB"
 })
 Tabs.Main:AddButton({
     Title = "YouTube : NEXUS HUB",
 ...
 Tabs.Main:AddButton({
     ...
     game.StarterGui:SetCore("SendNotification", {
         Title = "NEXUS HUB",
         Text = "Discord : NEXUS HUB",
         Icon = "rbxassetid://117690494697166",
         Duration = 6
     })
         setclipboard("https://discord.gg/gxVeMU6dNS")
     end
 })
